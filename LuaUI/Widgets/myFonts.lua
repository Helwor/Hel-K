...
local function RawGetTextWidth(text)
	...
	-- Echo(text:len(),'get width',text,w)
	return w
end
...
local function GetListCentered(text)
...
function widget:Initialize()
	...
	FH.GetListCentered		= GetListCentered
