...
MakeSubWindow = function(path, pause, labelScroll, minized)
	if pause == nil then
		pause = true
	end
    ...
    if WG.MakeMinizable then
        WG.MakeMinizable(window_sub_cur,minized)
    end
