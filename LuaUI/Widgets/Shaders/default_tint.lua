...
return
{
  ...
  void main(void)
  {
     ...
     // the line above make it blink, as I suppose because one of the two values is sometime (0.0,0.0,0.0)
     vec3 specular   = extraColor.g * 4.0;

     vec3 reflection = textureCube(reflectTex,  reflectDir).rgb;
     vec3 mini = mix(0.5,0.5,0.5);
